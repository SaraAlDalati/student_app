...
import 'package:student_app/parent/screen/aboutsubparent.dart';
import 'package:student_app/parent/screen/assignparent.dart';
import 'package:student_app/parent/screen/marksubparent.dart';
...
import '../controller/courseparcontroller.dart';
...
class SubjectPar extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
          ...
          body: TabBarView(
            children: [AboutSubParent(), AssignSubParent(), MarkSubParent()],
          )),
    );
  }
}
