...
import '../controller/aboutsubparcontroller.dart';
...
class AboutSubParent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    AboutSubParController aboutsubparcontroller = Get.find();
    return Scaffold(
              ...
              Padding(
                ...
                child: Container(
                 ...
                 // aboutsubcontroller.isLoading?Center(child: CircularProgressIndicator(),):
                   GetBuilder<AboutSubParController>(
                    builder: (aboutsubparcontroller)=>
                     Column(children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: ListTile(
                              ...
                              title: Text(
                                "${aboutsubparcontroller.aboutsubpar!.teacher!.firstName}",
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                      ...
                      Container(
                        ...
                        child: Center(
                            child: Text( "${aboutsubparcontroller.aboutsubpar!.about!.numberOfWeeklyClasses}",
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    color: Color.fromARGB(255, 141, 168, 209),
                                    fontSize: 20.sp,
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                        child: Text("${aboutsubparcontroller.aboutsubpar!.about!.topMark}",
                                            style: TextStyle(
                                                fontFamily: 'Montserrat',
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                        child: Text("${aboutsubparcontroller.aboutsubpar!.about!.lowerMark}",
                                            style: TextStyle(
                                                fontFamily: 'Montserrat',
                                                color: Color.fromARGB(
                                                    255, 141, 168, 209),
