class AboutSubModel {
  ...
  AboutSubModel({this.status, this.message, this.teacher, this.about});
...
class About {
  ...
  About.fromJson(Map<String, dynamic> json) {
    ...
    numberOfWeeklyClasses = json['number_of_weekly_classes'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['number_of_weekly_classes'] = this.numberOfWeeklyClasses;
