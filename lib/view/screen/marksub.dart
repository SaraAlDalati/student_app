...
class MarkSub extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    MarkSubController marksubcontroller = Get.find();
    
    return Scaffold(
      //appBar: AppBar(),
      backgroundColor: Color.fromRGBO(244, 241, 241, 1),
      body:GetBuilder<MarkSubController>(builder: (marksubcontroller )=>
         Padding(
                     ...
                     Expanded(
                       child: GridView.builder(
                        scrollDirection: Axis.horizontal,
                          ...
                          itemCount:marksubcontroller.First.length,
                          ...
                          children: [Padding(
                            ...
                            child:   Text(
                                     ...
                                     "${marksubcontroller.First[index].type}",
        ...
        fontSize: 15.sp,
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                          child: Text("${marksubcontroller.First[index].score}",
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Padding(
                  padding: const EdgeInsets.symmetric(vertical: 20,horizontal: 21),
                  child: GetBuilder<MarkSubController>(
                    builder: (marksubcontroller) => 
                     Expanded(
                       child: GridView.builder(
                        scrollDirection: Axis.horizontal,
                          gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
                          ...
                          itemCount: marksubcontroller.Second.length,
                          itemBuilder: (BuildContext context, int index) {
                            return Column(
                          ...
                          children: [Padding(
                            ...
                            child:   Text(
                                          ...
                                          "${marksubcontroller.Second[index].type}",
        ...
        fontSize: 15.sp,
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                          child: Text(   "${marksubcontroller.Second[index].score}",
                                              style: Theme.of(context)
                                                  .textTheme
                                                  .headline5)),
                                    ),
