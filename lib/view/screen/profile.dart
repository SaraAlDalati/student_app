...
extendBody: true,
     ...
     profilecontroller.isLoading?Center(child: CircularProgressIndicator(),):
      ...
      children: [
        TextSpan(text: "${profilecontroller.studentprofile.value!.firstName}",style: TextStyle(
                          fontFamily: 'Montserrat',
                          color: darkblue,
                          fontSize: 26.sp,
                          fontWeight: FontWeight.w800)),TextSpan(
          text: " ${profilecontroller.studentprofile.value!.lastName}",
          style: TextStyle(
                          fontFamily: 'Montserrat',
                          color: darkblue,
                          fontSize: 26.sp,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: Text("${profilecontroller.studentprofile.value!.gradeId}",
                                  style: TextStyle(
                                      fontFamily: 'Montserrat',
                                      color: darkblue,
                                      fontSize: 20.sp,
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Center(
                                child: Text("${profilecontroller.studentprofile.value!.sectionId}",
                                    style: TextStyle(
                                        fontFamily: 'Montserrat',
                                        color: darkblue,
                                        fontSize: 20.sp,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: Text("${profilecontroller.studentprofile.value!.type}",
                                  style: TextStyle(
                                      fontFamily: 'Montserrat',
                                      color: darkblue,
                                      fontSize: 20.sp,
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Center(
                            child: Text("${profilecontroller.studentprofile.value!.dateOfBirth}",
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    color: darkblue,
                                    fontSize: 20.sp,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: Text("${profilecontroller.studentprofile.value!.phoneNumber}",
                                  style: TextStyle(
                                      fontFamily: 'Montserrat',
                                      color: darkblue,
                                      fontSize: 20.sp,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Center(
                              child: Text("${profilecontroller.studentprofile.value!.address}",
                                  style: TextStyle(
                                      fontFamily: 'Montserrat',
                                      color: darkblue,
                                      fontSize: 15.sp,
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Text( "${profilecontroller.studentprofile.value!.bio}",
                                style: TextStyle(
                                    fontFamily: 'Montserrat',
                                    color: darkblue,
                                    fontSize: 14.sp,
